...
OVMF_FW = WORKSPACE_DIR / "qemu_boot" / "edk2-i386-code.fd"
OVMF_VARS = WORKSPACE_DIR / "qemu_boot" / "edk2-i386-vars.fd"
...
def build_command():
  ...
  startup_file.write("\EFI\BOOT\BOOT.EFI")
  startup_file.close()
